...
where d.assessment_session_id = a.id and d.guest_session_id = g.id and g.claimed_organization_id = a.organization_id and a.organization_id is not null;
update public.chat_sessions c set organization_id = a.organization_id, guest_session_id = null
from public.assessment_sessions a, public.guest_sessions g
where c.assessment_session_id = a.id and c.guest_session_id = g.id and g.claimed_organization_id = a.organization_id and a.organization_id is not null;
update public.report_artifacts r set organization_id = a.organization_id, guest_session_id = null
from public.assessment_sessions a, public.guest_sessions g
where r.assessment_session_id = a.id and r.guest_session_id = g.id and g.claimed_organization_id = a.organization_id and a.organization_id is not null;
update public.leads l set organization_id = a.organization_id, guest_session_id = null
from public.assessment_sessions a, public.guest_sessions g
where l.assessment_session_id = a.id and l.guest_session_id = g.id and g.claimed_organization_id = a.organization_id and a.organization_id is not null;
update public.consultant_notes n set organization_id = a.organization_id
from public.assessment_sessions a, public.guest_sessions g
where n.assessment_session_id = a.id and g.claimed_assessment_session_id = a.id and g.claimed_organization_id = a.organization_id and n.organization_id is null;
