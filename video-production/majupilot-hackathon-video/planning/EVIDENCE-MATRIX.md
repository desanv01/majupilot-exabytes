...
| DEMO-05 | Functional Prototype Demonstration | Case A Balanced Growth range: first-year cost RM9,200 / RM18,400 / RM27,600; operational value RM2,358 / RM7,254 / RM15,233; net value -RM25,242 / -RM11,146 / RM6,033; deterministic payback 7.2 / 30.4 / 140.5 months. The current UI displays the worst value as `More than 60 months`. | Implemented | Live `/scenarios` and `/blueprint`; Phase I browser evidence; Stage 4 capture | Call these conditional planning ranges, not ROI guarantees or vendor pricing. Preserve the production display label while keeping the underlying value documented. |
...
- Case A Balanced Growth payback: 7.2 / 30.4 / 140.5 months best / base / worst in deterministic data; live UI labels the worst value `More than 60 months`.
