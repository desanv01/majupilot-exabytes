...
| B Durable persistence and authorization | Ready | Pending V2 main-task dispatch | - | Dedicated Supabase project configuration, ordered migrations, repositories, roles, guest ownership/claim, versioned consent, RLS/private storage, retention/export/deletion services, and tenant-isolation proof. |
